...
%BUILDEXAMPLE Build an example.
    ...
    'sources', {{ ...
      fullfile(root_dir, 'example', 'private', 'Database.cc'), ...
      fullfile(root_dir, 'example', 'private', 'Environment.cc'), ...
      fullfile(root_dir, 'src', 'mexplus', 'arguments.cc'), ...
      fullfile(root_dir, 'src', 'mexplus', 'mxarray.cc'), ...
      fullfile(root_dir, 'src', 'mexplus', 'dispatch.cc') ...
      }}, ...
